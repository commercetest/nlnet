...
data = {
    "CommitHash": [
        "516722647ae474746a84c197127e323135907d57",
        "516722647ae474746a84c197127e323135907d57",
        "516722647ae474746a84c197127e323135907d57",
        "3efd6e0f03c3dabbbc9acbb52b058e0482d146ad",
        "3efd6e0f03c3dabbbc9acbb52b058e0482d146ad",
    ],
    ...
    "EfficacyMetric": [
        ...
        0.88,
        0.91,
    ],  # Hypothetical metric, if relevant
}
...
for index, row in df.iterrows():
    ...
    g.add(
        (
            observation_uri,
            mv.testFileCount,
            Literal(row["TestFileCount"], datatype=XSD.integer),
        )
    )
