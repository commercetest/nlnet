...
def dataframe_row_to_ttl(row):
    ...
    test_file_count = row['testfilecount']
    ...
    graph.add((subject_uri, project_namespace.testFileCount, Literal(test_file_count, datatype=XSD.integer)))
...
rdf_string = dataframe_row_to_ttl(df.iloc[0])
print(rdf_string)
